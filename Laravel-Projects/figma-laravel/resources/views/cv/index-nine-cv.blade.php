...
<head>
    ...
    <link href='https://fonts.googleapis.com/css?family=Inter' rel='stylesheet'>
    <link rel="stylesheet" type="text/css" href="{{asset('assets/nine-cv.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('assets/six-cv.css')}}">

    <title>Ninth CV</title>
</head>
<body>
 ...
 <div class="manange-shape" >
 <div class="row">
     
         <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12" style="background-color: #DDE6FF;height:320px;">
             <div class="avatar">
                 <img src="{{ asset('assets/images/avatar.png') }}" alt="profile picture" width="230" height="230" >
             </div>
         </div>
         <div class="col-xl-8 col-lg-8 col-md-8 col-sm-12 col-12" style="background-color: #DDE6FF;height:320px;">
 ...
 {{--  row email data  --}}
 <div class="row" style="background-color:#DDE6FF;height:60px;">
     <div class="col-xl-1 col-lg-1 col-md-1 col-sm-12 col-12" style="height:1px;"></div>
     <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12" style="background-color: #DDE6FF;height:20px;">
        <div> <img src="{{ asset('assets/images/email.png') }}" alt="profile picture">  
           <span class="font-spell">Your Email</span>
        </div>
     </div>
     <div class="col-xl-1 col-lg-1 col-md-1 col-sm-12 col-12" style="height:1px;"></div>
 
         <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12" style="background-color: #DDE6FF;height:20px;">
             <div> <img src="{{ asset('assets/images/location.png') }}" alt="profile picture">  
                 <span class="font-spell">address</span>
              </div>
         </div>
         <div class="col-xl-1 col-lg-1 col-md-1 col-sm-12 col-12" style="height:1px;"></div>
 
             <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 col-12" style="background-color:#DDE6FF;height:20px;">
                 <div> <img src="{{ asset('assets/images/phone.png') }}" alt="profile picture">  
                     <span class="font-spell">phone number</span>
                  </div>
             </div>
     ...
     <div class="row">
             ...
             <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12 col-12" style="background-color:#FFFFFF;height:820px;">
                    <div class="profile-shape">
                        <h2 class="skill-name myprofile">Profile</h2>
                 <div class="parent">

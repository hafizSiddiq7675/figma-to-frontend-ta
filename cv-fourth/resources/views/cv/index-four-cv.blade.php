...
<body>
    <div class="card">
        ...
        <div class="container">
            <div class="row">
                <div class="col-xl-5 col-lg-5 col-md-5 col-sm-12 col-12" style="background-color: #F4EFD7;height:1020px;">
                    <div class="avatar">
                ...
                <div class="col-xl-7 col-lg-7 col-md-7 col-sm-12 col-12" style="background-color:#ffff;height:1020px; ">

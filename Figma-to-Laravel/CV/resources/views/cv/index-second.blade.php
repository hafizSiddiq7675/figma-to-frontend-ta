            ...
            <div class="row">
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="preview-column-right">
                        <div class="avatar">
                            <img src="{{asset('assests/images/avatar.png')}}" alt="profile Pic">
                        </div>

                        <div class="parent-image">
                            <div class="image-block">
                                <div> 
                                    <img src="{{asset('assests/images/email.png')}}" alt="profile Pic">
                                    <img src="{{url('/assets/images/myimage.jpg')}}" alt="profile Pic">
                                </div>
                                <div> <img src="{{asset('assests/images/location.png')}}" alt="profile Pic">
                                </div>
                                <div><img src="{{asset('assests/images/phone.png')}}" alt="profile Pic">
                                </div>
                        ...
                        <img src="{{asset('assests/images/edge.png')}}" alt="profile Pic" width="100%" height="170" style="padding-top:6px;">
                    </div>

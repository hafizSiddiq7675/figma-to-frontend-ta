...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('assets/crypto.css') }}">
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12" >
        ...
        <div class="section-div" >
            <div class="data-block">
                ...
                <div class="ratio-bit">
                    <p class="btc-usd">BTC/USDT</p>
                    <img src="{{ asset('assets/images/ratio.png') }}" height="20" width="40" class="ratio-img"> 
                </div>
                <div><p class="price-value">55350.21</p></div>
                <div><p class="second-value">55350.21</p></div>

            </div>            
            <div class="data-block2 white-block" >
                <div>
                    <img src="{{ asset('assets/images/dollar.png') }}" > 
                </div>
                <div class="ratio-bit">
                    <p class="btc-usd">BTC/USDT</p>
                    <img src="{{ asset('assets/images/greenratio.png') }}" height="20" width="40" class="ratio-img"> 
                </div>
                <div><p class="price-value">55350.21</p></div>
                <div><p class="second-value">55350.21</p></div>
            ...
            <div class="data-block ">
                <div>
                    <img src="{{ asset('assets/images/diamond.png') }}" > 
                </div>
                <div class="ratio-bit">
                    <p class="btc-usd">BTC/USDT</p>
                    <img src="{{ asset('assets/images/greenratio.png') }}" height="20" width="40" class="ratio-img"> 
            ...
            <div class="data-block">
                <div>
                    <img src="{{ asset('assets/images/spring.png') }}" > 
                </div>
                <div class="ratio-bit">
                    <p class="btc-usd">BTC/USDT</p>
                    <img src="{{ asset('assets/images/greenratio.png') }}" height="20" width="40" class="ratio-img"> 
...
<div class="row">
    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 ">
        <div class="div-details"><p class="details">Lorem ipsum dolor sit amet, consectetur adipiscing elit.
             Nunc vulputate libero et velit interdum, ac aliquet odio mattis. 
            Classw aptent taciti sociosqu ad litora torque</p></div>
    </div>

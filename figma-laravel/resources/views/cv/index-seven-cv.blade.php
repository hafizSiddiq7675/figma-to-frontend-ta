...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{asset('assets/seven-cv.css')}}">
        ...
        <div class="card ">
          <div class="container">
            <div class="row" style="height:290px;">
                ...
                <div class="col-xl-11 col-lg-11 col-md-11 col-sm-12 col-12" style="background-color: #FEE0EB;">
              ...
              <div class="avatar-right"><img src="{{ asset('assets/images/avatar.png') }}" height="210" width="210" alt="profile picture" ></div> 
                    </div>
                </div>
                        <div class="col-xl-1 col-lg-1 col-md-1 col-sm-12 col-12" style=";margin-left:-16px;">
                           <div> <img src="{{ asset('assets/images/edge1.png') }}"  width="95px" height="295px" alt="profile picture" ></div>
                        </div>
                </div>
            <div class="row">
